class Upgrade extends Phaser.GameObjects.Sprite
{
	...
	upgrades = [
		...
		{ upgrade: "max health", chance: 10,
			minFlat: 1, maxFlat: 10, minPercent: 1.1, maxPercent: 1.5 },
		{ upgrade: "move speed", chance: 10,
			minFlat: 15, maxFlat: 50, minPercent: 1.03, maxPercent: 1.1 },
		{ upgrade: "dash cooldown", chance: 10,
			minFlat: 0.1, maxFlat: 0.33, minPercent: 0.1, maxPercent: 0.33 },
		{ upgrade: "net damage", chance: 10,
			minFlat: 1, maxFlat: 10, minPercent: 1.1, maxPercent: 1.5 },
		{ upgrade: "net range", chance: 5,
			minFlat: 10, maxFlat: 50, minPercent: 1.1, maxPercent: 1.5 },
		{ upgrade: "net knockback", chance: 5,
			minFlat: 100, maxFlat: 375, minPercent: 1.1, maxPercent: 1.5 },
		...
		{ upgrade: "bread range", chance: 10,
			minFlat: 35, maxFlat: 100, minPercent: 1.05, maxPercent: 1.2 },
		{ upgrade: "bread velocity", chance: 5,
			minFlat: 50, maxFlat: 100, minPercent: 1.05, maxPercent: 1.25 },
		{ upgrade: "bread knockback", chance: 5,
			minFlat: 150, maxFlat: 500, minPercent: 1.05, maxPercent: 1.25 },
		{ upgrade: "bread cooldown", chance: 10,
			minFlat: 0.05, maxFlat: 0.2, minPercent: 0.1, maxPercent: 0.33 },
		{ upgrade: "bread size", chance: 5,
			minFlat: 10, maxFlat: 50, minPercent: 1.1, maxPercent: 1.5 },
		{ upgrade: "invincibility duration", chance: 5000,
			minFlat: 0.1, maxFlat: 0.25, minPercent: 1.5, maxPercent: 2 }
